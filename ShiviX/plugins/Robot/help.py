    ...
    if cb == "hb9":
        if CallbackQuery.from_user.id not in SUDOERS:
            return await CallbackQuery.answer(
                "Haa Jii Loda lelo Mera.\n\nAukat Nhi Or Owner Banne Gya.", show_alert=True
            )
        else:
