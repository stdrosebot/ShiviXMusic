...
from ShiviX import (Apple, Resso, SoundCloud, Spotify, Telegram,
                        YouTube, app)
from ShiviX.core.call import Shivi
from ShiviX.utils import seconds_to_min, time_to_seconds
from ShiviX.utils.channelplay import get_channeplayCB
from ShiviX.utils.database import is_video_allowed
from ShiviX.utils.decorators.language import languageCB
from ShiviX.utils.decorators.play import PlayWrapper
from ShiviX.utils.formatters import formats
from ShiviX.utils.inline.play import (livestream_markup,
                                          playlist_markup,
                                          slider_markup, track_markup)
from ShiviX.utils.inline.playlist import botplaylist_markup
from ShiviX.utils.logger import play_logs
from ShiviX.utils.stream.stream import stream
    ...
    if audio_telegram:
        ...
        if await YouTube.exists(url):
            ...
            if (
                ...
                return await mystic.edit_text(
                    "this bot can't play spotufy tracks and playlists, please contact bot owner and ask his to add spotify player."
                )
            if "track" in url:
                try:
            ...
            try:
                ...
                return await app.send_message(
                    config.LOG_GROUP_ID,
                    "please turn on videochat to stream url.",
                )
            except Exception as e:
                return await mystic.edit_text(
...
async def anonymous_check(client, CallbackQuery):
    try:
        await CallbackQuery.answer(
            "you are an anonymous admin\n\nrevert back to user account for use me.",
            show_alert=True,
        )
    except:
        return
