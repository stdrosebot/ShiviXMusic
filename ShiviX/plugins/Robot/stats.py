...
from ShiviX.misc import SUDOERS, pymongodb
from ShiviX.plugins import ALL_MODULES
from ShiviX.utils.database import (get_global_tops,
                                       get_particulars, get_queries,
                                       get_served_chats,
                                       get_served_users, get_sudoers,
                                       get_top_chats, get_topp_users)
from ShiviX.utils.decorators.language import language, languageCB
from ShiviX.utils.inline.stats import (back_stats_buttons,
                                           back_stats_markup,
                                           get_stats_markup,
    ...
    def get_stats():
        ...
        if what in ["Tracks", "Here"]:
            for items, count in list_arranged.items():
                ...
                if items == "telegram":
                    msg += f" [telegram meadia](https://t.me/world_friends_chattings) ** played {count} times**\n\n"
                else:
