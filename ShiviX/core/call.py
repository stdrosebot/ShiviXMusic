...
from ShiviX import LOGGER, YouTube, app
from ShiviX.misc import db
from ShiviX.utils.database import (add_active_chat,
...
from ShiviX.utils.exceptions import AssistantErr
from ShiviX.utils.inline.play import (stream_markup,
                                          telegram_markup)
    ...
    async def join_call(
        ...
        try:
            ...
            try:
                ...
                raise AssistantErr(
                    "**No Active Vidoe Chat Found**\n\nplease make sure you started the videochat."
                )
        except AlreadyJoinedError:
            raise AssistantErr(
                "**assistant already in videochat**\n\nmusic bot systems detected that assistant is already in the videochat, if this problem continues restart the videochat and try again."
            )
        except TelegramServerError:
            raise AssistantErr(
                "**telegram server error*\n\nplease trun off and restart the videochat again."
            )
