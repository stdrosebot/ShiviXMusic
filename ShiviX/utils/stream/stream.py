...
import config
from ShiviX import Carbon, YouTube, app
...
from ShiviX.utils.inline.play import (stream_markup,
                                          telegram_markup)
from ShiviX.utils.inline.playlist import close_markup
from ShiviX.utils.pastebin import Shivibin
from ShiviX.utils.stream.queue import put_queue, put_queue_index
...
async def stream(
    ...
    if forceplay:
        await Shivi.force_stop_stream(chat_id)
